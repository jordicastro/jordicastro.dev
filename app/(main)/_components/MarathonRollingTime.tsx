...
interface MarathonRollingTimeProps {
    className?: string;
    textSize?: string;
    widthHeight?: string;
    animationKey: string;
    registerAnimation: (key: string, build: FlourishBuilder) => void;
}

export default function MarathonRollingTime({className, textSize, widthHeight, animationKey, registerAnimation}: MarathonRollingTimeProps) {
